...
const handleWrongGuess = () => {
  ...
  if (numWrong === 1) {
    sharkImg.setAttribute('src', 'guess1.png');
  }else if (numWrong === 2) {
    sharkImg.setAttribute('src', 'guess2.png');
  }else if (numWrong === 3) {
    sharkImg.setAttribute('src', 'guess3.png');
  }else if (numWrong === 4) {
    sharkImg.setAttribute('src', 'guess4.png');
  }else if (numWrong === 5) {
    sharkImg.setAttribute('src', 'guess5.png');
